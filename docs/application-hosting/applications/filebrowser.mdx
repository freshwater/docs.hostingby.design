...
As of writing this documentation (25.3.2025), filesharing is only possible if you share the credentials to your slot with the person you're sharing a file to, but this functionality has been added to our dev platform and will be pushed out as soon as it's verified to work.
